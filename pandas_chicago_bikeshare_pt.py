...
for i in range(20):
    ...
    print(f"Amostra do indice {i} não contém a informação gênero." if len(
        genero) == 0 else genero)
...
# ------------ NÃO MUDE NENHUM CÓDIGO AQUI ------------
# assert male == 935854 and female == 298784, "TAREFA 4: A conta não bate." Teste inválido
# -----------------------------------------------------
